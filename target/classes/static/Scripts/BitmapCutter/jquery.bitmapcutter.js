...
$.extend(
    $.fn, {
        //<summary>fetch css value</summary>
        //<param name="c">style name</param>
        f: function (c) {
            return parseInt($(this).css(c));
        },

        //<summary>preload bitmap</summary>
...
//                $('.jquery-bitmapcutter-info').html(w + ' : ' + h);
        ...
        //<summary>resize, drag and drop//</summary>
        ...
        //<summary>bitmap cutter, main function</summary>
        ...
        bitmapCutter: function (settings) {
            ...
            var ps = $.fn.extend({
                ...
                cutterSize: { width: 100, height: 100 },
                zoomStep: 0.2,
                zoomIn: 2.0,
                zoomOut: 0.1,
                rotateAngle: 90,
            ...
            //<sammary>zoom interface</sammary>
...
//                                    .css('width', ps.holderSize.width);
            ...
            //thumbnail
            var $thumbimg = $('<img id="bitmapcutterCr" alt="" rel="' + ps.src + '" />')
                                                    .appendTo(
